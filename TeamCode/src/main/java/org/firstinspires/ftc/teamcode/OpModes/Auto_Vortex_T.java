 ...
 */
@Autonomous(name = "Letter T", group = "Autonomous")
public class Auto_Vortex_T extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        navigation.driveDistance(50, Constants.DRIVE_SPEED);

        navigation.turnDegrees(90, Constants.TURN_SPEED);

        navigation.driveDistance(25, Constants.DRIVE_SPEED);
